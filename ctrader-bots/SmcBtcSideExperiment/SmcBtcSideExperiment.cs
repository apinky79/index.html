// -------------------------------------------------------------------------------------------------
// SmcBtcSideExperiment — SIDE EXPERIMENT ONLY (does not replace UltimateTrader2026 / Test G)
//
// Lean Smart Money Concepts cBot for cTrader:
//   HTF (default H4)  → market structure bias (BOS direction)
//   LTF (chart, m15)  → liquidity sweep → CHoCH → order-block retest entry
//
// No Level-2 order book required — SMC here is pure OHLC price-action.
// Chart: attach on BTCUSD m15 (or any symbol). Set BiasTimeFrame = Hour4.
// -------------------------------------------------------------------------------------------------
...
namespace cAlgo.Robots
{
    ...
    public class SmcBtcSideExperiment : Robot
    {
        // ---- Identity / direction ---------------------------------------------------------------
        ...
        [Parameter("Order Direction", DefaultValue = TradeDirectionMode.LongAndShort, Group = "Trade Options")]
        ...
        protected override void OnStart()
        {
            ...
            Print("SmcBtcSideExperiment started — SIDE EXPERIMENT. Chart TF={0} Bias TF={1}", Bars.TimeFrame, BiasTimeFrame);
        ...
        private void TryEnterOnOrderBlock(int i)
        {
            ...
            bool longOk = OrderDirection != TradeDirectionMode.ShortOnly;
            bool shortOk = OrderDirection != TradeDirectionMode.LongOnly;
